<x-mail::layout>
    ...
    <x-slot:header>
        <x-mail::header :url="config('app.url')" style="background-color: #f8fafc; padding: 20px;">
            <img src="https://litpers.propammalut.id/logo.png" alt="{{ config('app.name') }} Logo"
    ...
    <div
        ...
        <h2 style="color: #333; font-size: 20px;">{{ $slot }}</h2>
    </div>
    ...
    <x-slot:footer>
        <x-mail::footer style="background-color: #f8fafc; padding: 10px; text-align: center;">
            <p style="margin: 0; color: #777;">© {{ date('Y') }} {{ config('app.name') }}. @lang('All rights reserved.')</p>
